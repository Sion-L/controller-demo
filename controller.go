...
import (
	...
	crdv1beta1 "github.com/Sion-L/controller-demo/pkg/apis/stable/v1beta1"
	informers "github.com/Sion-L/controller-demo/pkg/client/informers/externalversions/stable/v1beta1"
)
...
// 尝试从 Informer 维护的缓存中拿到了它所对应的 CronTab 对象 , 也是从index拿
